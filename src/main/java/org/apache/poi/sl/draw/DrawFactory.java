...
public class DrawFactory {
	...
	/**
	 * Set a custom draw factory for the current thread. This is a fallback, for
	 * operations where usercode can't set a graphics context. Preferably use the
	 * rendering hint {@link Drawable#DRAW_FACTORY} to set the factory.
	 *
	 * @param factory
	 */
	...
	/**
	 * Returns the DrawFactory, preferably via a graphics instance. If graphics is
	 * null, the current thread local is checked or if it is not set, a new factory
	 * is created.
	 *
	 * @param graphics
	...
	/**
	 * Convenience method for drawing single shapes. For drawing whole slides, use
	 * {@link Slide#draw(Graphics2D)}
	 *
	 * @param graphics
	...
	/**
	 * Replace font families for Windows JVM 6, which contains a font rendering
	 * error. This is likely to be removed, when POI upgrades to JDK 7
	 *
	 * @param graphics
	...
	public void fixFonts(Graphics2D graphics) {
		...
		String fonts[][] = { { "Calibri", "Lucida Sans" }, { "Cambria", "Lucida Bright" },
				{ "Times New Roman", "Lucida Bright" }, { "serif", "Lucida Bright" } };
