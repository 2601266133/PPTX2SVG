...
public class XSLFValueAxis extends XSLFChartAxis implements ValueAxis {

	private CTValAx ctValAx;

	public XSLFValueAxis(XSLFChart chart, long id, AxisPosition pos) {
		super(chart);
		createAxis(id, pos);
	}

	public XSLFValueAxis(XSLFChart chart, CTValAx ctValAx) {
		super(chart);
	...
	private static AxisCrossBetween toCrossBetween(STCrossBetween.Enum ctCrossBetween) {
		...
		case STCrossBetween.INT_BETWEEN:
			return AxisCrossBetween.BETWEEN;
		case STCrossBetween.INT_MID_CAT:
