...
public class XSLFManualLayout implements ManualLayout {
	 ...
	 */
	public XSLFManualLayout(CTLayout ctLayout) {
		initLayout(ctLayout);
	}
	 ...
	 */
	public XSLFManualLayout(XSLFChart chart) {
	...
	private LayoutMode toLayoutMode(CTLayoutMode ctLayoutMode) {
		...
		case STLayoutMode.INT_EDGE:
			return LayoutMode.EDGE;
		case STLayoutMode.INT_FACTOR:
	...
	private LayoutTarget toLayoutTarget(CTLayoutTarget ctLayoutTarget) {
		...
		case STLayoutTarget.INT_INNER:
			return LayoutTarget.INNER;
		case STLayoutTarget.INT_OUTER:
