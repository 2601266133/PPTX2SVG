 ...
 * by the {@link org.apache.batik.svggen.SVGGraphics2D} to generate SVG from
 * Java 2D primitives. You can subclass it to change the defaults.
 *
...
public class SVGGeneratorContext implements ErrorConstants {
	 ...
	 * This allows different strategies to be used to handle images.
	 * 
	 ...
	 * TransformStacks operation is based on that assumption. See the DOMTreeManager
	 * class).
	 */
	...
	/**
	 * Creates an instance of <code>SVGGeneratorContext</code> with the given
	 * <code>domFactory</code> and with the default values for the other
	 * information.
	 * 
	...
	/**
	 * Sets the default to be used for the graphic context. Note that gcDefaults may
	 * be null and that any of its attributes may be null.
	 */
	...
	/**
	 * Sets the {@link org.apache.batik.svggen.SVGIDGenerator} to be used. It should
	...
	/**
	 * Returns the {@link org.apache.batik.svggen.ExtensionHandler} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link org.apache.batik.svggen.ExtensionHandler} to be used. It
	...
	/**
	 * Sets the {@link org.apache.batik.svggen.ImageHandler} to be used. It should
	 * not be <code>null</code>.
	 */
	...
	/**
	 * Sets the {@link org.apache.batik.svggen.StyleHandler} to be used. It should
	 * not be <code>null</code>.
	 */
	...
	/**
	 * Sets the comment to be used. It can be <code>null</code> if you want to
	 * disable it.
	 */
	...
	/**
	 * Sets the {@link org.apache.batik.svggen.ErrorHandler} to be used. It should
	 * not be <code>null</code>.
	 */
	...
	/**
	 * Sets if we should generate SVG Fonts for texts. Default value is
	 * <code>false</code>.
	 */
	...
	/**
	 * Sets the precision used by this context. The precision controls the number of
	 * decimal places used in floating point values output by the SVGGraphics2D
	 * generator. Note that the precision is clipped to the [0,12] range.
	 */
	...
	/**
	 * Converts the input double value to a string with a number of decimal places
	 * controlled by the precision attribute.
	 */
