 ...
 *
 * Child Elements Subclause blipFill (Picture Fill) §5.1.10.14 cs (Complex
 * Script Font) §5.1.5.3.1 ea (East Asian Font) §5.1.5.3.3 effectDag (Effect
 * Container) §5.1.10.25 effectLst (Effect Container) §5.1.10.26 extLst
 * (Extension List) §5.1.2.1.15 gradFill (Gradient Fill) §5.1.10.33 grpFill
 * (Group Fill) §5.1.10.35 highlight (Highlight Color) §5.1.5.3.4 hlinkClick
 * (Click Hyperlink) §5.1.5.3.5 hlinkMouseOver (Mouse-Over Hyperlink) §5.1.5.3.6
 * latin (Latin Font) §5.1.5.3.7 ln (Outline) §5.1.2.1.24 noFill (No Fill)
 * §5.1.10.44 pattFill (Pattern Fill) §5.1.10.47 solidFill (Solid Fill)
 * §5.1.10.54 sym (Symbol Font) §5.1.5.3.10 uFill (Underline Fill) §5.1.5.3.12
 * uFillTx (Underline Fill Properties Follow Text) §5.1.5.3.13 uLn (Underline
 * Stroke) §5.1.5.3.14 uLnTx (Underline Follows Text) §5.1.5.3.15
 *
 *
 *
...
public class DefaultTextRunProperties {
