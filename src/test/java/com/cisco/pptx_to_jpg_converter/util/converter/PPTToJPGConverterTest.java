...
import com.cisco.pptx_to_jpg_converter.util.PPTToJPGConverter;

@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
public class PPTToJPGConverterTest {
	File pptFile = null;
	...
	public void testNormal() throws Exception {
		...
		PPTToJPGConverter converter = new PPTToJPGConverter(fIn, "src/test/resources/images/", "jpg");
		converter.convert();
