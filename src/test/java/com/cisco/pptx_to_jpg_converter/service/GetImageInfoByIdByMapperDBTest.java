...
@Transactional
@Rollback(true)
public class GetImageInfoByIdByMapperDBTest {
	@Autowired
	...
	public void setUp() throws Exception {
		...
		String sql1 = "insert into pptinfo(ID,FILE_PATH,FILE_NEW_NAME,FILE_ORIGN_NAME,FILE_SIZE,IMAGE_PATH,IMAGE_UUID,CREATED_DT,CREATED_BY) values(-1,'D:/junit/ppt/','117junit.pptx','junit.pptx','6MB','D:/junit/images/118/','118',current_timestamp,'junit');";
		String sql2 = "insert into pptinfo(ID,FILE_PATH,FILE_NEW_NAME,FILE_ORIGN_NAME,FILE_SIZE,IMAGE_PATH,IMAGE_UUID,CREATED_DT,CREATED_BY) values(-2,'D:/junit/ppt/','1171junit.pptx','junit.pptx','6MB','D:/junit/images/1181/','1181',current_timestamp,'junit');";
	...
	public void testNormal() throws Exception {
		ImageInformation result = pptMapper.getImageById("-1");
		assertEquals("D:/junit/images/118/", result.getImagePath());
		assertEquals("001.jpg", result.getImageName());
