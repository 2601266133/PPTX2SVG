...
@Transactional
@Rollback(true)
public class GetPPTsByMapperDBTest {
	...
	public void setUp() throws Exception {
		...
		String sql1 = "insert into pptinfo(ID,FILE_PATH,FILE_NEW_NAME,FILE_ORIGN_NAME,FILE_SIZE,IMAGE_PATH,IMAGE_UUID,CREATED_DT,CREATED_BY) values(-1,'D:/junit/ppt/','117junit.pptx','junit.pptx','3MB','D:/junit/images/118/','118',current_timestamp,'junit');";
		String sql2 = "insert into pptinfo(ID,FILE_PATH,FILE_NEW_NAME,FILE_ORIGN_NAME,FILE_SIZE,IMAGE_PATH,IMAGE_UUID,CREATED_DT,CREATED_BY) values(-2,'D:/junit/ppt/','1171junit.pptx','junit.pptx','3MB','D:/junit/images/1181/','1181',current_timestamp,'junit');";
	...
	public void testNormal() throws Exception {
		...
		for (PPTInformation ppt : results) {
			if ("-1".equals(ppt.getId())) {
				...
				assertEquals("-1", ppt.getImageInfoList().get(0).getId());
			}
			if ("-2".equals(ppt.getId())) {
				assertEquals("D:/junit/ppt/", ppt.getFilePath());
				assertEquals("1171junit.pptx", ppt.getFileNewName());
				assertEquals("junit.pptx", ppt.getFileOrignName());
				assertEquals("D:/junit/images/1181/", ppt.getImagePath());
				assertEquals("1181", ppt.getImageUUID());
				assertEquals("-2", ppt.getImageInfoList().get(0).getId());
			}
		}
	}
